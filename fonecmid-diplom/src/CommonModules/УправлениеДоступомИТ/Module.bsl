...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// Папка профилей "ВКМ_Дроздков".
	ОписаниеПапки = УправлениеДоступом.НовоеОписаниеПапкиПрофилейГруппДоступа();
	ОписаниеПапки.Имя           = "ВКМ_Дроздков";
	ОписаниеПапки.Идентификатор = "76a45b22-3c4e-11ef-8ae8-3005053871d2";
	ОписаниеПапки.Наименование  =
		НСтр("ru = 'ВКМ_Дроздков'",
			ОбщегоНазначения.КодОсновногоЯзыка());
	ОписанияПрофилей.Добавить(ОписаниеПапки);

	// Профиль "БухгалтерИТФирмы".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Родитель      = "ВКМ_Дроздков";
	ОписаниеПрофиля.Идентификатор = "76a45b29-3c4e-11ef-8ae8-3005053871d2";
	...
	ОписаниеПрофиля.Роли.Добавить("БазоваяФункциональностьТП");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_МассовоеСозданиеДокументовРеализацияТоваровИУслуг");
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Родитель      = "ВКМ_Дроздков";
	ОписаниеПрофиля.Идентификатор = "74fb66cb-412c-11ef-8aeb-3005053871d2";
	ОписаниеПрофиля.Наименование  =
	...
	ОписаниеПрофиля.Роли.Добавить("БазоваяФункциональностьТП");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ВводДанныхОбОкладахИПремиях");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ВводДанныхОбОтпусках");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ЗаполнениеДанныхГрафика");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_НачислениеИВыплатаЗарплаты");
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Родитель      = "ВКМ_Дроздков";
	ОписаниеПрофиля.Идентификатор = "76a45b2a-3c4e-11ef-8ae8-3005053871d2";
	ОписаниеПрофиля.Наименование  =
		НСтр("ru = 'Менеджер'",
			ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Описание =
	...
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСДокументомОбслуживаниеКлиентов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСПараметрамиРассылкиВТелеграм");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Родитель      = "ВКМ_Дроздков";
	ОписаниеПрофиля.Идентификатор = "76a45b2b-3c4e-11ef-8ae8-3005053871d2";
	ОписаниеПрофиля.Наименование  =
		НСтр("ru = 'Специалист'",
			ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Описание =
	...
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСДокументомОбслуживаниеКлиентов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСоСправочникомВидыРабот");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСОтчетомВыработкаСпециалистов");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеПапокИФайлов");
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
