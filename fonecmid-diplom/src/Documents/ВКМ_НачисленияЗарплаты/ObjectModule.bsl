...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если Начисления.Количество() <> 0 Тогда
		...
		Если НЕ ЕстьСотрудникиСНеустановленнымиОкладамиИлиПремиями Тогда
			...
			//Очистка предыдущих движений регистра накопления "ОтпускаСотрудников"
...
Процедура РассчитатьОтпуск(Движение)
	...
	КонецЕсли;
		...
		СформироватьДвижениеУдержания(Движение);
		СформироватьПриходПоРегиструВзаиморасчетыССотрудниками(Движение);
		СформироватьПриходПоРегиструНакопленияОтпуск(Движение, КоличествоДнейОтпуска);
...
Процедура СформироватьПриходПоРегиструНакопленияОтпуск(Движение, КоличествоДнейОтпуска)
